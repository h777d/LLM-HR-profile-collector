...
class profilesearcher(BaseModel):
    profilesearcher: List[str] = Field(description="Main list")

    def to_dict(self) -> Dict[str, Any]:
        return {"profilesearcher": self.profilesearcher}
...
profilesearcher_parser = PydanticOutputParser(pydantic_object=profilesearcher)
